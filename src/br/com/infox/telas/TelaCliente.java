...
public class TelaCliente extends javax.swing.JInternalFrame {
    ...
    private void adicionar() {
        ...
        try {
            ...
            if ((txtCliNome.getText().isEmpty()) || (txtCliFone.getText().isEmpty())) {
                ...
                //confirma inserçao de dados
                int adicionado = pst.executeUpdate();
                //verifica o valor de "adicionado"
    ...
    private void pesquisarCliente() {
        ...
        try {
            ...
            // atencao ao "%" -> continuacao da Sting sql
    ...
    //preenche campos do formulario com o conteudo da tabela
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(txtCliFone, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    private void txtCliPesquisarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCliPesquisarKeyReleased
        // chamar pesquisarCliente
        pesquisarCliente();
    }//GEN-LAST:event_txtCliPesquisarKeyReleased

    //evento para preencher os campos com dados da tabela
